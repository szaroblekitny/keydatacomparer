...
/**
 * Key data comparer main package. It gets configuration file, reads tables
 * to compare and produces file with output: different records and missing records
 * between two databases: source database and compared databse.
 */
